...
\begin{itemize}
    ...
    \item Création des fichiers LaTeX pour les documents à rendre
    \begin{itemize}
        ...
        \item Création de \textit{test.tex} - Liste et description des tests 
        effectués
    \end{itemize} 
\end{itemize}
...
\begin{itemize}
    ...
    \begin{itemize}
        \item Création \textit{relocation.c} 
    \end{itemize}
